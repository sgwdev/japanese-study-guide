...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20231204151151_AddKanjiListSchema")]
    partial class AddKanjiListSchema
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.KanjiAggregate.KanjiList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_kanji_list");

                    b.ToTable("kanji_list");
                });

            modelBuilder.Entity("Core.Entities.KanjiAggregate.KanjiListMapping", b =>
                {
                    b.Property<int>("KanjiId")
                        .HasColumnType("integer")
                        .HasColumnName("kanji_id");

                    b.Property<int>("KanjiListId")
                        .HasColumnType("integer")
                        .HasColumnName("kanji_list_id");

                    b.HasKey("KanjiId", "KanjiListId")
                        .HasName("pk_kanji_list_kanji");

                    b.HasIndex("KanjiListId")
                        .HasDatabaseName("ix_kanji_list_kanji_kanji_list_id");

                    b.ToTable("kanji_list_kanji", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.KanjiAggregate.KanjiListMapping", b =>
                {
                    b.HasOne("Core.Entities.KanjiAggregate.Kanji", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_kanji_list_kanji_kanji_kanji_id");

                    b.HasOne("Core.Entities.KanjiAggregate.KanjiList", null)
                        .WithMany()
                        .HasForeignKey("KanjiListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_kanji_list_kanji_kanji_list_kanji_list_id");
                });
